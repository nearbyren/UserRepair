...
open class BaseWebView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : WebView(context, attrs), LifecycleEventObserver {
...
//                println("WebViewJavascriptBridge ->  白屏检测任务：像素点总数为 $pixelCount - 白屏检测任务：白色像素点计数为 $whitePixelCount - 白屏检测任务：其他颜色像素点计数为 $otherPixelCount")

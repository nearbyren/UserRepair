 ...
 * 保留零位小数
 */
val Double.precision0: String
    get() = NumberUtils.format(
        digit = this.toString(),
        maxPrecision = 0,
        minPrecision = 0,
 ...
 * 保留两位小数
 */
val Double.precision2: String
    get() = NumberUtils.format(digit = this.toString(), mode = RoundingMode.DOWN)

/**
 * 保留零位小数
 */
val BigDecimal.precision0: String
    get() = NumberUtils.format(
        digit = this.toString(),
        maxPrecision = 0,
        minPrecision = 0,
 ...
 * 保留一位小数
 */
val BigDecimal.precision1: String
    get() = NumberUtils.format(
        digit = this.toString(),
        maxPrecision = 1,
        minPrecision = 1,
 ...
 * 保留两位小数
 */
val BigDecimal.precision2: String
    get() = NumberUtils.format(digit = this.toString(), mode = RoundingMode.DOWN)

/**
 * 保留一位小数
 */
val Int.precision1: String
    get() = NumberUtils.format(digit = this.toString(), mode = RoundingMode.DOWN)

/**
 * 保留两位小数
 */
val Int.precision2: String
    get() = NumberUtils.format(digit = this.toString(), mode = RoundingMode.DOWN)